...
(function() {
  ...
  const CarouselBlocos = {
    ...
    bindEvents: function() {
      ...
      this.mainContent.addEventListener('touchstart', (e) => this.onTouchStart(e), false);
      this.mainContent.addEventListener('touchend', (e) => this.onTouchEnd(e), false);
    ...
    checkIsMobile: function() {
      ...
      if (wasMobile !== this.isMobile) {
        console.log(`📱 Modo mudou para: ${this.isMobile ? 'MOBILE' : 'DESKTOP'}`);
      }
    },
    ...
    onScroll: function() {
      ...
      if (newBloco !== this.currentBloco) {
        ...
        console.log(`📍 Bloco atual: ${this.currentBloco + 1}/${this.totalBlocos}`);
        this.updateIndicators();
      }
